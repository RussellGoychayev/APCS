// Stack Underflow (Ariel Fuchs + Duck, Nada Hameed + Ray, Russell Goychayev + Bob)
// APCS pd7
...
public class StatPrinter
{
  ...
  {
    /* YOUR IMPLEMENTATION HERE */
    double r = ((double)longestBar) / max(_frequency);
    String dots;
    int dotNum = 0;
    for (int i = 0; i < _frequency.size(); i++){
      dots = "";
      dotNum = (int)(_frequency.get(i) * r);
      for (int x = 0; x < dotNum; x++){
        dots += "*";
      }
      System.out.println(i + " : " + dots);
    }
  }
