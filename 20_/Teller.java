...
Their Team Jason Zhou (Roster: Nina Jiang, John Gupta-she Duckies: Miss Alpaca, Tiggy, Po)
APCS
HW?
10/18/2021
...
public class Teller {
    ...
    public Teller(String name, String pss, int id, int pinnum, double setBalance) {
        //Randomize?
        if (id > 100000000 && id < 999999998) { //should be inclusive for both
            accId = id;
        } else {
        ...
        if (pinnum > 1000 && pinnum < 9998) { //should also be inclusive for both
            accPin = pinnum;
        } else {
            System.out.println("Pin Not Valid!!!! Not 4 digits!\n"); //must set pin to 9999
        }
        accName = name;
        accPss = pss;
        verified = false;
    ...
    */
    ...
    public static void main(String[] args) {
        Teller elmo = new Teller("elmo", "e", 111111111, 1011, 69);
